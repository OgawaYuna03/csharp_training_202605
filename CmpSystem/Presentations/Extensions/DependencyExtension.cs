...
using CmpSystem.Applications.Services.Impls;
using CmpSystem.Infrastructures.Adapters;
using CmpSystem.Infrastructures.Context;
using CmpSystem.Infrastructures.Repositories;
using CmpSystem.Presentations.Controllers;
using CmpSystem.Presentations.ViewModels;
namespace CmpSystem.Presentations.Extensions;
/// <summary>
/// 依存定義および依存性注入クラス
/// </summary>
